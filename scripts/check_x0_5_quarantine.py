...
SAFE_SOURCE_PATHS = (
    ...
    "docs/phase_x_x5_5_contribution_triage.md",
    "docs/evidence_audit_part6_cross_claim_statistics.md",
...
DATA_SOURCE_POLICY = {
    ...
    "output/results/evidence_audit_x5_5": (
        "CURRENT-EVIDENCE",
        "C1-C4 triage",
        "Final contribution disposition and X6.5 waiver",
        "X5.5 triage",
    ),
    "output/results/evidence_audit_part6": (
        "CURRENT-EVIDENCE",
        "Cross-Claim overlay",
        "Statistical integrity and paper eligibility",
        "X6 audit",
    ),
